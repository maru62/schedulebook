...
class HoursControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hour" do
    assert_difference("Hour.count") do
      post hours_url, params: { hour: { action: @hour.action, date: @hour.date, health: @hour.health, hour: @hour.hour, mood: @hour.mood } }
    end
  ...
  test "should update hour" do
    patch hour_url(@hour), params: { hour: { action: @hour.action, date: @hour.date, health: @hour.health, hour: @hour.hour, mood: @hour.mood } }
