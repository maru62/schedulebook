...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference("Day.count") do
      post days_url, params: { day: { date: @day.date, event: @day.event, expense: @day.expense, memo: @day.memo } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { date: @day.date, event: @day.event, expense: @day.expense, memo: @day.memo } }
